...
function(target_linuxdeploy)
    add_custom_target(linuxdeploy pwd
        ...
        COMMAND "${LINUXDEPLOYQT}" ${PROJECT_NAME} --appimage-extract-and-run -appimage -verbose=3 -no-strip|| true
...
function(add_appimage)
    ...
    if(NOT DEFINED LINUXDEPLOYQT)
        spark_debug_message("AppImage> Not Found LINUXDEPLOYQT Variable!")
        return()
    endif(NOT DEFINED LINUXDEPLOYQT)
    if(CMAKE_VERSION VERSION_LESS 3.19 AND NOT EXISTS ${LINUXDEPLOYQT})
        spark_debug_message("> cmake version is less than 3.19")
    ...
    spark_debug_message("AppImage> Found LINUXDEPLOYQT Variable: ${LINUXDEPLOYQT_REAL_PATH}")

    # check appimagetool
    if(NOT DEFINED APPIMAGETOOL)
        spark_debug_message("AppImage> Not Found APPIMAGETOOL Variable!")
        return()
    ...
    spark_debug_message("AppImage> Found APPIMAGETOOL Variable: ${LINUXDEPLOYQT_REAL_PATH}")
...
function(add_appimage_icon _ICON_PATH)
    if(CMAKE_VERSION VERSION_LESS 3.21)
        spark_debug_message("> cmake version is less than 3.21")
